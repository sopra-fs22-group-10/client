...
//export const testSession = {playerList: playerList, currentPlayer: 2, opponentPlayer: 3,
    ...
    export const testSession = {"currentPlayer":null,"opponentPlayer":null,"playerList":[{"playerId":parseInt(localStorage.getItem('UserID')),"playerName":"","playerStatus":"ACTIVE","hand":[],"playedCards":[]}],"winner":null};//,{"playerId":19,"playerName":"user1","playerStatus":"ACTIVE","hand":[{"cardId":5,"cardname":"Cardname51","image":"randomimage51","cardstats":[{"statId":2,"statvalue":"5","statname":"StatName1","stattype":"STARS","valuestypes":null},{"statId":3,"statvalue":"10","statname":"StatName2","stattype":"NUMBER","valuestypes":null},{"statId":4,"statvalue":"100","statname":"StatName3","stattype":"VALUE","valuestypes":"1"}]}],"playedCards":[]}]}
